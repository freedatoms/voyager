...
void HistoryMenu::postPopulated()
{
    ...
    QAction *showAllAction = new QAction(QIcon(QLatin1String(":/history.png")),tr("Show All History"), this);
#if !defined(Q_WS_MAC)
    ...
    QAction *clearAction = new QAction(QIcon(QLatin1String(":/history-clean.png")),tr("Clear History..."), this);
...
QVariant HistoryTreeModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DecorationRole: {
        if (index.column() == 0 && !index.parent().isValid())
            return QIcon(QLatin1String(":history-item.png"));
    }
