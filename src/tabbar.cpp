...
{
    QMenu menu;
    menu.addAction(QIcon(QLatin1String(":/tab-new.png")),tr("New &Tab"), this, SIGNAL(newTab()), QKeySequence::AddTab);
    ...
    if (-1 != index) {
        ...
        action = menu.addAction(QIcon(QLatin1String(":/tab-close.png")),tr("&Close Tab"),
